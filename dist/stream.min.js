...
f=j(f)}return f},0);return{end:h,stream:k,memoStream:n,cons:function(b,d){return k(b,s(d))},concat:r,concatz:l,concata:function(){return 0===arguments.length?h:w.call(arguments,v)},from:function(b){return void 0===b?h:q(b,0,b.length)},first:function(b){return b.a},rest:j,isEmpty:function(b){return b===h},isStream:function(b){return b&&b.hasOwnProperty("first")&&b.hasOwnProperty("rest")},forEach:p,reduce:t,reduceRight:x,toArray:function(b){return t(b,u,[])},map:y,filter:z}});
