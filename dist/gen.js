...
define(["require", "exports", "./stream"], (function(require, exports, __o) {
    ...
    (range = (function(lower, upper, step) {
        ...
        return (isNaN(upper) ? (((rangeStep > 0) ? (rangeLower <= 0) : (rangeLower >= 0)) ? NIL :
            memoStream(0, rangeImpl.bind(null, (0 + rangeStep), rangeLower, rangeStep))) : (((
            rangeStep > 0) ? (upper <= rangeLower) : (upper >= rangeLower)) ? NIL : memoStream(
            rangeLower, rangeImpl.bind(null, (rangeLower + rangeStep), upper, rangeStep))));
    }));
